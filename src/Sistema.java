...
public class Sistema {
    ...
    private static GerenciadorPratos gerenciadorPratos = new GerenciadorPratos();
    ...
    private static GerenciadorReservas gerenciadorReservas = new GerenciadorReservas();
